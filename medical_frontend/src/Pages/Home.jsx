  ...
  return (
    <div className="h-screen w-full">
        ...
        <div className="bg-[#33AC6B] w-full ">
            <button className="bg-white text-[#33AC6B] px-6 py-2 rounded-full absolute top-8 right-12" onClick={() => navigate('/user-login')}>
                Login
            </button>

            <div className="pt-28 pl-12 text-center mb-16">
                <h1 className="text-[#fff] text-8xl font-bold justify-center">Online Medical System</h1>
                <h2 className="text-[#fff] text-7xl">Faculty of Computing</h2>
                <h3 className="text-[#fff] text-6xl">Sabaragamuwa University of Sri Lanka</h3>
            </div>

            <img className="absolute right-10 h-126 w-96" src="https://historia.institute/wp-content/uploads/2024/05/Person_Web.png"/>

            <div className=" absolute bg-white h-96 w-3/5 ml-16 mt-24 rounded-4 opacity-85 border-[#33AC6B] border-solid border-2">
                <p className="text-justify text-xl m-10">Lorem Ipsumes simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las 
